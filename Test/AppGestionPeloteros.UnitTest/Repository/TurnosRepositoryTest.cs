    ...
    { 
        ...
        public async Task GetByWeek_ReturnsTurnos()
        {
            ...
            _context.Turnos.AddRange(
                new Turno { TurnoId = Guid.NewGuid(),FechaReserva= [1] , Fecha = week , Cliente = cliente },
                new Turno { TurnoId = Guid.NewGuid(), FechaReserva = [1] , Fecha = week.AddDays(1), Cliente = cliente },
                new Turno { TurnoId = Guid.NewGuid(), FechaReserva = [1] , Fecha = week.AddDays(-2), Cliente = cliente }
            );
